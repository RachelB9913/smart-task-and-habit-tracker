...
function removeCompletion(type, id) {
  ...
  const filtered = completions.filter(entry => entry.taskId !== id && entry.cloneId !== id);
                                        ...
                                        <div className="habit-icons">
                                         ...
                                         <button
                                            ...
                                            onClick={(e) => {
                                              ...
                                              removeCompletion("habit", id); // 🔁 Remove completion if habit is unscheduled
                                            }}
                                          >❌</button>
                                        </div>
                                      </div>
                                            ...
                                            <>
                                              ...
                                              <button
                                                ...
                                                onClick={(e) => {
                                                  ...
                                                  removeCompletion("task", task.id); // 🔁 Remove completion if task is unscheduled
                                                }}
                                              >❌</button>
                                            </>
                                          )}
