    ...
    <div className="welcome-root">
      ...
      <section className="features">
        ...
        <div className="feature-cards">
            <TiltedCard imageSrc="https://source.unsplash.com/300x300/?task">
                <h3>📋 Smart Task Management 📋</h3>
                <p>Easily create, organize, and prioritize tasks.</p>
            </TiltedCard>

            <TiltedCard imageSrc="https://source.unsplash.com/300x300/?habit">
                <h3>📆 Habit Tracking 📆</h3>
                <p>Track your habits and build positive routines.</p>
            </TiltedCard>

            <TiltedCard imageSrc="https://source.unsplash.com/300x300/?timer">
