                                        ...
                                        <div className="habit-icons">
                                          <button
                                            ...
                                            onClick={(e) => {
                                              ...
                                              const alreadyDone = completions.some(entry => entry.cloneId === id); // `id` is cloneId
                                            ...
                                            <>
                                              <button
                                                ...
                                                onClick={(e) => {
                                                  ...
                                                  const alreadyDone = completions.some(entry => entry.taskId === task.id);

                                                  if (alreadyDone) {
                                                    // ↩️ Undo
                                                    const updated = completions.filter(entry => entry.taskId !== task.id);
                                                    localStorage.setItem("taskCompletions", JSON.stringify(updated));
                                                    task.status = "In Progress"; // reset visually
                                                  } else {
                                                    // ✅ Mark as done
                                                    const updated = [
                                                      ...completions,
