...
public class HabitController {
    ...
    @DeleteMapping("/schedule/clear")
    public ResponseEntity<?> clearHabitSchedule() {
        habitRepository.deleteAll(); // Replace with your actual repo call
        return ResponseEntity.ok("All habit schedules cleared");
    }
}
